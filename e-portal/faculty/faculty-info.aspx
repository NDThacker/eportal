<%@ Page Language="C#" MasterPageFile="~/faculty/Faculty.Master" AutoEventWireup="true" CodeBehind="faculty-info.aspx.cs" Inherits="e_portal.faculty.faculty_info" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <table class="auto-style1" style="padding: 8px; font-family: Arial, Helvetica, sans-serif; font-size: medium">
            ...
            <tr>
                <td class="auto-style4" style="padding: 5px">
                    <asp:Label ID="Label39" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="Medium" Text="Login-ID : "></asp:Label>
                </td>
                <td style="padding: 5px">
            ...
            <tr>
                ...
                <td style="padding: 5px" aria-atomic="False" aria-autocomplete="none" aria-disabled="True" aria-selected="true">
                    <asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" Font-Underline="True" MaxLength="30" Visible="False" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Update Details" />
                ...
                <td style="padding: 5px">
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/faculty/change-Fpassword.aspx">Change Password?</asp:HyperLink>
                </td>
                <td style="padding: 5px" aria-atomic="False" aria-autocomplete="none" aria-disabled="True" aria-selected="true">
