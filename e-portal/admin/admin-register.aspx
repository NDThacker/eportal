<%@ Page Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="admin-register.aspx.cs" Inherits="e_portal.admin.Admin_registration" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Large" Font-Underline="True" Text="New Admin Registration"></asp:Label>
            <br />
            <br />
