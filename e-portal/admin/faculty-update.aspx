<%@ Page Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="faculty-update.aspx.cs" Inherits="e_portal.admin.faculty_update" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Large" Font-Underline="True" Text="Update Faculty Details"></asp:Label>
            <br />
            <br />
&nbsp;&nbsp;&nbsp;
                ...
                <table class="auto-style1" style="padding: 8px; font-family: Arial, Helvetica, sans-serif; font-size: medium">
                    ...
                    <tr>
                        ...
                        <td class="auto-style3" style="padding: 5px" aria-atomic="False" aria-autocomplete="none" aria-disabled="True" aria-selected="true">
                            ...
                            <asp:Label ID="Label43" runat="server" ForeColor="Red" Text="*" Visible="False"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style4" style="padding: 5px">
                    ...
                    <tr>
                        <td class="auto-style4" style="padding: 5px">
                            <asp:Label ID="Label47" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="Medium" Text="Password : "></asp:Label>
                        </td>
                        <td style="padding: 5px">
                            <asp:Label ID="Label48" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="Medium" Text="Password"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td class="auto-style4" style="padding: 5px">
                            <asp:Label ID="Label45" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="Medium" Text="Login-ID : "></asp:Label>
                        </td>
                        <td style="padding: 5px">
                            <asp:Label ID="Label46" runat="server" Font-Bold="False" Font-Names="Arial" Font-Size="Medium" Text="Login-ID"></asp:Label>
                        </td>
                        <td style="padding: 5px" aria-atomic="False" aria-autocomplete="none" aria-disabled="True" aria-selected="true">
                            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Update" Visible="False" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Cancel" Visible="False" style="height: 26px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style4" style="padding: 5px">
