<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sem-attendance.aspx.cs" Inherits="e_portal.student.sem_attendance" %>
    ...
    <form id="form2" runat="server">
        <asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="X-Large" ForeColor="#990000" Orientation="Horizontal" RenderingMode="Table" StaticSubMenuIndent="10px" Width="100%">
            ...
            <Items>
                ...
                <asp:MenuItem NavigateUrl="~/student/attendance.aspx" Text="Attendance" Value="Attendance" Selected="True"></asp:MenuItem>
        ...
        <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="sem"></asp:Label>
            ...
            <asp:Table ID="Table1" Border="1" runat="server" CssClass="auto-style1" BackColor="White" BorderColor="#00FF99" CellPadding="12" CellSpacing="0" EnableTheming="True" Font-Bold="False" Font-Size="Larger">
               <asp:TableRow>
                   ...
                   <asp:TableCell BackColor="Aquamarine">
                       <center>
                           <asp:Label ID="Label16" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="Theory-Obtain"></asp:Label>
                        </center>
                   </asp:TableCell>
                   <asp:TableCell BackColor="Aquamarine">
                       <center>
                           <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="Theory-Total"></asp:Label>
                        </center>
                   </asp:TableCell>
                   <asp:TableCell BackColor="Aquamarine">
                       <center>
                           <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="Pratical-Obtain"></asp:Label>
                        </center>
                   </asp:TableCell>
                   <asp:TableCell BackColor="Aquamarine">
                       <center>
                           <asp:Label ID="Label14" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="Pratical-Total"></asp:Label>
                        </center>
                   </asp:TableCell>
               </asp:TableRow>
            </asp:Table>
