<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="result.aspx.cs" Inherits="e_portal.student.result" %>
...
<br />
        ...
        <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="Year"></asp:Label>
            ...
            <asp:Table ID="Table1" Border="1" runat="server" CssClass="auto-style1" BackColor="White" BorderColor="#00FF99" CellPadding="12" CellSpacing="0" EnableTheming="True" Font-Bold="False" Font-Size="Larger" Width="791px">
               <asp:TableRow>
                   <asp:TableCell BackColor="Aquamarine">
                       <center>
                           <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="View Result"></asp:Label>
                        </center>
                   </asp:TableCell>
                   <asp:TableCell BackColor="Aquamarine">
                       <center>
                   ...
                   <asp:TableCell BackColor="Aquamarine">
                       <center>
                           <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Names="Arial" Font-Overline="False" Font-Size="Large" Font-Strikeout="False" Font-Underline="False" Text="Result"></asp:Label>
                        </center>
                   </asp:TableCell>
               </asp:TableRow>
            </asp:Table>
